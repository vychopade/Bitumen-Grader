...
# Match the colours in app/assets/style.qss so Python-built widgets look the same.
...
def link_button_qss(*, color: str = TEXT_SECONDARY) -> str:
    """Style a text-looking button so we do not stack a second outlined control. Pass a colour to override the default grey."""
    return (
